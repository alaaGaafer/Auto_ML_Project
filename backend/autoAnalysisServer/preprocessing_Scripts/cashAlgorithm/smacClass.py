...
class Models:
    def __init__(self, similarModels, problemType, X_train, Y_train, X_test, Y_test, freq='D', s=7):
...
class Facade:
    ...
    def ClassificationFacade(self):
        ...
        smac = HyperparameterOptimizationFacade(scenario, classifier.train, overwrite=True,
