      ...
      <div className="container p-3 my-4 rounded shadow bg-white">
        <div className="row">
          <div className="col-md-3">
            ...
            <button onClick={handleOptions} className='btn btn-danger w-100 my-2 d-block m-auto text-capitalize'>Low variance</button>
            ...
            <button onClick={handleOptions} className='btn btn-danger w-100 my-2 d-block m-auto text-capitalize'>Handling imbalance class</button>
          </div>
          ...
          <div className="col-md-3 text-capitalize bg-danger rounded position-relative">
            ...
            <div id="Low variance" className={selectedOption === 'Low variance' ? 'options' : 'options d-none'}>
              <p>column name </p>
              <select defaultValue='' className='mb-2 form-control text-capitalize' name="low variance" id="low variance">
                <option value="" disabled hidden>low variance</option>
            ...
            <div id="Handling imbalance class" className={selectedOption === 'Handling imbalance class' ? 'options' : 'options d-none'}>
              <p>column name </p>
              <select defaultValue='' className='mb-2 form-control text-capitalize' name="Handling imbalance class" id="Handling imbalance class">
